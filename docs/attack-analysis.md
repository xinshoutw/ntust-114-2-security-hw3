...
|---|---:|---:|---:|---:|
| original | — | 90.00% | 98.75% | 0.3234 |
| pix_b2 | 2 | **92.50%** | **100.00%** | 0.4328 |
| pix_b4 | 4 | 90.00% | 98.75% | 0.3491 |
| pix_b8 | 8 | 91.25% | **100.00%** | 0.3469 |
| pix_b16 | 16 | 90.00% | 97.50% | **0.5703** |

> †Top-5 / Test Loss 沿用前一次 `scripts/evaluate.py` 的紀錄；Top-1 為當次 `scripts/attack_analysis.py` 對 committed checkpoints 的結果。
...
|---|---:|---:|---:|---:|
| original | — | 90.00% | 98.75% | 0.3234 |
| blur_k15 | 15 | 91.25% | 98.75% | 0.4382 |
| blur_k45 | 45 | 88.75% | 100.00% | 0.4785 |
| blur_k99 | 99 | **86.25%** | 98.75% | **0.5482** |

> †Top-5 / Test Loss 沿用前一次 `scripts/evaluate.py` 的紀錄。
